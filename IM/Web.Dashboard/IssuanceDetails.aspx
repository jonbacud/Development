                                ...
                                <asp:TemplateField ShowHeader="False">
                                    <ItemTemplate>
                                        <asp:HyperLink ID="hpLinkViewDetails"  data-hint-color="fg-white" runat="server" data-role="hint"
                                                    data-hint-background="bg-blue" data-hint="Info.|View Details" data-hint-position="left" Target="_blank" ToolTip="Viwe Details" runat="server"
                                            NavigateUrl='<%# "issuacnce-detail/"+Eval("Uid") %>'>
