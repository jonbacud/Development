<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DonationDetails.aspx.cs" Inherits="Web.Dashboard.DonationDetails" %>
            ...
            <div class="flex-grid">
                <div class="row ">
                    <div class="cell auto-size margin5">
                        ...
                        <div class="input-control text full-size ">
                            <asp:DropDownList runat="server" ID="DDLDonatedTo" AutoPostBack="True"  />
                        </div>
                    </div>
                    <div class="cell auto-size margin5">
                                    ...
                                    <ItemTemplate>
                                        <asp:HyperLink ID="HyperLink1" runat="server" data-role="hint" 
                                            data-hint-background="bg-blue" data-hint="Info.|View Donation Item Details" data-hint-position="left"
                                                    NavigateUrl='<%# "~/donation-detail-entry/0/"+Eval("Id")%>'>
